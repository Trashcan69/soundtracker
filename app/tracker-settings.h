...
#define TRACKERSETTINGS(obj) (G_TYPE_CHECK_INSTANCE_CAST(obj, trackersettings_get_type(), TrackerSettings))
#define TRACKERSETTINGS_CLASS(klass) (G_TYPE_CHECK_CLASS_CAST(klass, trackersettings_get_type(), TrackerSettingsClass))
...
GType trackersettings_get_type(void) G_GNUC_CONST;
